...
<script type="text/javascript">
	...
	function chkContent(){
		...
		if(reg.test(content)){//输入正确
			...
			spanEle.innerHTML="内容不能为空，不能全是空格,可以换行";
			spanEle.style.color="red";
			//重新聚焦
			conEle.focus();
			submitContent=false;
			...
			<tbody id="tab_1">
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="title" id="title" onblur="chkTitle()" maxlength="100" size="100"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<textarea name="content" id="content" onblur="chkContent()" rows="30" cols="100"></textarea>
				...
				<!-- <tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text"  name="crtime" id="crtime" onblur="chkCrtime()" maxlength="80"   class="Wdate" onclick="WdatePicker()" readonly="readonly"/>
