...
<div class="body-box" style="float:right">
	<form id="jvForm" action="update.do?id=${article.id }" method="post" onsubmit="return chkAll()" >
			...
			<tbody id="tab_1">
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="title" id="title" maxlength="100" size="100" value="${article.title }"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<textarea name="content" id="content" rows="30" cols="100">${article.content }</textarea>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="author" id="author" maxlength="100" size="30" value="${article.author }"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text"  name="crtime" id="crtime" maxlength="80"   class="Wdate" onclick="WdatePicker()" readonly="readonly" value="${article.crtimeTxt }"/>
					...
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<select name="channel.id">
							<c:forEach items="${channels }" var="channel">
								<c:if test="${article.channel.id==channel.id }">
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<c:if test="${article.isremod!=1 }">
							...
							<input type="radio" name="isremod" value="-1" checked="checked"/>非推荐
						</c:if>
					</td>
				</tr>
				<tr>
